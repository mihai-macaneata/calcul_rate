           ...
           let xAxis = x.domain(parsedData.map(function(d) { return d.Date }));
            ...
            bar_container.append('text')
                ...
                .attr("x", function(d) { 
                    ...
                    if(d.Date === '2018-01') {
                        return x(d.Date) + parsedData.length * width/500 - 5
                    }
                    else {
                        return x(d.Date) + 10 
                    }
            ...
            bar_container.append('rect')
                .attr("x", function(d) { 
                    if(d.Date === '2018-01'){
                        ...
                        return x(d.Date) + parseInt(parsedData.length * width/500) - 10
                    } else {
                        return x(d.Date) + parseInt(parsedData.length * width/500)
            ...
            bar_container.append('rect')
                ...
                .attr("width",  function(d) { 
                    if(d.referinta === true) {
                        ...
                        return parsedData.length * width/600
                    }
                })
                .attr("y", function(d) {
                    return y(0);
