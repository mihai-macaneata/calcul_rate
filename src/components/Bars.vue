    ...
    methods: {
        ...
        renderChart(svg, data) {
            ...
            if (window.matchMedia("(max-width: 768px)").matches) {
                barSizeWidth = computedWidth / 2.5
                mobile = true;
            } 
            ...
            bar_container.append('rect')
                ...
                .attr("x", function(d) {
                    return x(d.Date) + self.d3Position(mobile, d.Date, 10);
                })
                .attr("y", function(d) {
            ...
            bar_container.append('rect')
                .attr("class", "bar")
                .attr("x", function(d) {
                    return x(d.Date) + self.d3Position(mobile, d.Date);
                })
                .attr("width", barSizeWidth)
                .attr("y", function(d) {
                    return y(0);
            ...
            bar_container.append('text')
                ...
                .attr("x", function(d) {
                    ...
                    return x(d.Date) + (barSizeWidth - this.getBBox().width)/2 + self.d3Position(mobile, d.Date);
        ...
        d3Position(mobile, date, threshold = 0) {
            if(mobile) {
                if(date !== 2016) {
                    return 90 + threshold
                } 
